 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("james jiang");
		  toPrint += p1.toString("jjiang302");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Travis bostick");
		  toPrint += p2.toString("travisbostick");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Fernanda Moreno");
		  toPrint += p3.toString("fmoreno6");
		  //Person4 replace P4 with your name
		  //and gburdell4 with your gt id
		  Person4 p4 = new Person4("Rachel Lecesne");
		  toPrint += p4.toString("rlecesne3");
		  //Person5 replace P5 with your name
		  //and gburdell5 with your gt id
		  Person5 p5 = new Person5("Jake Present");
		  toPrint += p5.toString("jpresent3");
